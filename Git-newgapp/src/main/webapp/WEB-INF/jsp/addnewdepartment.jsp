...
<body>
<form:form modelAttribute="addnewdepartments">
<table class="table table-condensed">
<tr><td>Enter the Department <form:input path="departmentname"/></td>
<td><input class="btn btn-primary btn-lnk" type="Submit" name="addnewdepartment" value="Add"></td></tr>

</table>
<a class="btn btn-primary btn-lnk" href="addprograms.html">Add New program</a>
